...
namespace DataMesh.AR.Anchor
{
    ...
    public class SceneAnchorController : DataMesh.AR.MEHoloModuleSingleton<SceneAnchorController>
    {
        ...
        public AdjustAnchorUI anchorUI;
        ...
        public bool NeedBlockOtherLayerInput = true;
        ...
        protected override void Awake()
        {
            ...
            anchorUI.gameObject.SetActive(false);
        ...
        protected override void _Init()
        {
            ...
            anchorUI.Init();
            anchorUI.cbConfirmClick = OnClickConfirm;
            anchorUI.cbQuitClick = OnClickQuit;
            anchorUI.cbMoveClick = OnClickMove;
            anchorUI.cbRotateClick = OnClickRotate;
            anchorUI.cbGazeClick = OnClickGaze;
        }
        ...
        {
            int layer = NeedBlockOtherLayerInput ? 0 : originInputLayer;
            switch (type)
            {
                case LayerMaskType.AnchorMark:
                    inputManager.layerMask = layer | markLayer | LayerMask.GetMask("UI");
                    break;
                case LayerMaskType.Spacial:
                    inputManager.layerMask = layer | SpatialMappingManager.Instance.LayerMask | LayerMask.GetMask("UI");
                    break;
        ...
        {
            ChangeAdjustType(SpatialAdjustType.Fitting);
        }
