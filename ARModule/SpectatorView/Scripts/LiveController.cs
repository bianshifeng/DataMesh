...
namespace DataMesh.AR.SpectatorView
{
    ...
    public class LiveController : MEHoloModuleSingleton<LiveController>
    {
        ...
        private bool FillVectorFromString(string s, out Vector3 v)
        {
            ...
            try
            {
                v.x = float.Parse(args[0], System.Globalization.CultureInfo.InvariantCulture);
                v.y = float.Parse(args[1], System.Globalization.CultureInfo.InvariantCulture);
                v.z = float.Parse(args[2], System.Globalization.CultureInfo.InvariantCulture);
            }
