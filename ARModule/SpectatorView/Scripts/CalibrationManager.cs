        ...
        private void ReadCalibrationData()
        {
            ...
            if (value != null)
            {
                ...
                data.Translation = new Vector3(
                    (float)Convert.ToDouble(tokens[0], System.Globalization.CultureInfo.InvariantCulture),
                    (float)Convert.ToDouble(tokens[1], System.Globalization.CultureInfo.InvariantCulture),
                    (float)Convert.ToDouble(tokens[2], System.Globalization.CultureInfo.InvariantCulture)
                    );
            ...
            if (value != null)
            {
                ...
                data.Rotation = Quaternion.LookRotation(
                    ...
                    new Vector3(
                        (float)Convert.ToDouble(tokens[6], System.Globalization.CultureInfo.InvariantCulture),
                        (float)Convert.ToDouble(tokens[7], System.Globalization.CultureInfo.InvariantCulture),
                        (float)Convert.ToDouble(tokens[8], System.Globalization.CultureInfo.InvariantCulture)
                    ),
                    // Second column as up direction.
                    new Vector3(
                        (float)Convert.ToDouble(tokens[3], System.Globalization.CultureInfo.InvariantCulture),
                        (float)Convert.ToDouble(tokens[4], System.Globalization.CultureInfo.InvariantCulture),
                        (float)Convert.ToDouble(tokens[5], System.Globalization.CultureInfo.InvariantCulture)
                    )
                );
            ...
            {
                String[] tokens = value.Split(new string[] { "," }, StringSplitOptions.RemoveEmptyEntries);
                data.DSLR_distortion = new Vector4((float)Convert.ToDouble(tokens[0], System.Globalization.CultureInfo.InvariantCulture),
                    (float)Convert.ToDouble(tokens[1], System.Globalization.CultureInfo.InvariantCulture),
                    (float)Convert.ToDouble(tokens[2], System.Globalization.CultureInfo.InvariantCulture),
                    (float)Convert.ToDouble(tokens[3], System.Globalization.CultureInfo.InvariantCulture));
            ...
            {
                String[] tokens = value.Split(new string[] { "," }, StringSplitOptions.RemoveEmptyEntries);
                data.DSLR_matrix = new Vector4((float)Convert.ToDouble(tokens[0], System.Globalization.CultureInfo.InvariantCulture),
                    (float)Convert.ToDouble(tokens[1], System.Globalization.CultureInfo.InvariantCulture),
                    (float)Convert.ToDouble(tokens[2], System.Globalization.CultureInfo.InvariantCulture),
                    (float)Convert.ToDouble(tokens[3], System.Globalization.CultureInfo.InvariantCulture));
