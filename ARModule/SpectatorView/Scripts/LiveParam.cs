    ...
    public static class LiveParam
    {
        ...
        public static bool LoadParam()
        {
            ...
            if (data != null)
            {
                ...
                {
                    antiShakeBeforeTime = float.Parse(data["AntiShakeBeforeTime"], System.Globalization.CultureInfo.InvariantCulture);
                }
                if (data.ContainsKey("AntiShakeAfterTime"))
                {
                    antiShakeAfterTime = float.Parse(data["AntiShakeAfterTime"], System.Globalization.CultureInfo.InvariantCulture);
                }
                if (data.ContainsKey("Alpha"))
                {
                    alpha = float.Parse(data["Alpha"], System.Globalization.CultureInfo.InvariantCulture);
                }
                if (data.ContainsKey("SyncDelayTime"))
                {
                    syncDelayTime = float.Parse(data["SyncDelayTime"], System.Globalization.CultureInfo.InvariantCulture);
                }
                if (data.ContainsKey("SoundVolume"))
                {
                    soundVolume = float.Parse(data["SoundVolume"], System.Globalization.CultureInfo.InvariantCulture);
                }
                ...
                {
                    filter = float.Parse(data["Filter"], System.Globalization.CultureInfo.InvariantCulture);
                }
                if (data.ContainsKey("FOV"))
                {
                    fov = float.Parse(data["FOV"], System.Globalization.CultureInfo.InvariantCulture);
                }
            }
            else
            {
