...
namespace DataMesh.AR.Account
{
    public class LoginUI : MonoBehaviour
    {
        ...
        public void Init()
        {
            ...
            keyboardManager = UIManager.Instance.keyboardManager;
...
//#if !UNITY_EDITOR && UNITY_UWP
            ...
            keyboardManager.Keyboard.callbackInputFinish += OnInputFinish;
            keyboardManager.Keyboard.callbackExit += OnInputExit;
//#else
